...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { amount: @good.amount, integer: @good.integer, price: @good.price, title: @good.title } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { amount: @good.amount, integer: @good.integer, price: @good.price, title: @good.title } }
